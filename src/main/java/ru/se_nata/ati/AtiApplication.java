...
@ComponentScan(basePackages = { "ru.se_nata.ati.formatter", "ru.se_nata.ati.service", "ru.se_nata.ati.controller","ru.se_nata.ati.repository","ru.se_nata.ati.security" })
